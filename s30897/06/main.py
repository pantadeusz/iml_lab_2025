...
# Usunięto nieużywany import HyperModel
...
def build_tuner_model(input_shape, num_classes):
    def build_model(hp):
        ...
        lr = hp.Choice('lr', values=[1e-3, 1e-4, 1e-5])
...
def run_tuner(train_ds, val_ds, input_shape, num_classes, max_trials=10, epochs=20):
    ...
    tuner = kt.RandomSearch(
        ...
        directory='tuner_results_beans_cnn',  # Lepsza nazwa katalogu
...
def main():
    ...
    model_path = 'beans_best_model_cnn.keras'
